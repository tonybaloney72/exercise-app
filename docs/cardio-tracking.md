...
| Engineering backlog (daily metrics phases) | [docs/ROADMAP.md](./ROADMAP.md) |
...
**Next:** HC **Exercise Route** import (`READ_EXERCISE_ROUTES` + consent UI); optional MapLibre basemap (v2). ME **polyline v1** shipped (`GpsRoutePolyline`, `gps_track_points`).
