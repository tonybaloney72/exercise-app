...
export const exercises: Exercise[] = [
  ...
  { id: "SW-1", name: "Arm Circles", category: "SW", defaultReps: "10 each direction", notes: "Arms out at shoulder level, small circles forward then backward", source: "Calisthenics Association", videoUrl: "https://www.youtube.com/watch?v=140RTNMciH8", isTimeBased: false },
  { id: "SW-2", name: "Shoulder Rolls", category: "SW", defaultReps: "10 each direction", notes: "Roll shoulders backward in slow circles, squeeze shoulder blades together", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=IKJZL4hvppw", isTimeBased: false },
  { id: "SW-3", name: "Cross-Body Arm Swings", category: "SW", defaultReps: "10 each side", notes: "Swing arms wide then cross in front of chest, alternate which arm is on top", source: "Muscle & Strength", videoUrl: "https://cdn.muscleandstrength.com/exercises/cross-body-arm-swings", isTimeBased: false, secondaryCategory: "UP" },
  { id: "SW-4", name: "Inchworms", category: "SW", defaultReps: "5", notes: "From standing, walk hands out to plank, pause, walk hands back, roll up", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=aFkv2m9FTGs", isTimeBased: false, secondaryCategory: "CS" },
  { id: "SW-5", name: "Torso Twists", category: "SW", defaultReps: "10 each side", notes: "Feet shoulder-width, arms at 90°, rotate torso side to side keeping hips still", source: "Your House Fitness", videoUrl: "https://yourhousefitness.com/blog/how-to-perform-the-torso-twist", isTimeBased: false, secondaryCategory: "CR" },
  { id: "SW-6", name: "Standing Side Bends", category: "SW", defaultReps: "8 each side", notes: "Reach one arm overhead, lean to opposite side, return. Alternate sides", source: "Wellls Fitness", videoUrl: "https://wellls.com/exercises/standing-side-bend", isTimeBased: false, secondaryCategory: "CR" },
  { id: "SW-7", name: "Cat-Cow", category: "SW", defaultReps: "10", notes: "On all fours — inhale: arch spine and look up (cow); exhale: round spine and tuck chin (cat)", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=zWtLlhFp8HY", isTimeBased: false, secondaryCategory: "CS" },
  { id: "SW-8", name: "Bird-Dog", category: "SW", defaultReps: "8 each side", notes: "On all fours, extend opposite arm and leg simultaneously, hold briefly, alternate", source: "BarBend", videoUrl: "https://barbend.com/best-dynamic-warm-up-exercises/", isTimeBased: false, secondaryCategory: "CS" },
  { id: "SW-9", name: "Thread the Needle", category: "SW", defaultReps: "5 each side", notes: "On all fours, thread one arm under the other rotating torso, then reach to ceiling", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=7C8-zj3nRro", isTimeBased: false, secondaryCategory: "UPL" },
  { id: "SW-10", name: "Scapular Push-Ups", category: "SW", defaultReps: "10", notes: "In plank, keep arms straight — retract shoulder blades together, then protract apart", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=iQP1BBmwAgg", isTimeBased: false, secondaryCategory: "UPL" },
  { id: "SW-11", name: "Walking Lunges", category: "SW", defaultReps: "8 each leg", notes: "Step forward into lunge, push off front foot, step into next lunge", source: "BarBend", videoUrl: "https://barbend.com/best-dynamic-warm-up-exercises/", isTimeBased: false, secondaryCategory: "LB" },
  { id: "SW-12", name: "Leg Swings (Front-Back)", category: "SW", defaultReps: "10 each leg", notes: "Hold wall for balance, swing one leg forward and back in controlled arc", source: "Runner's World", videoUrl: "https://www.youtube.com/watch?v=korxBhGzzJE", isTimeBased: false, secondaryCategory: "LB" },
  { id: "SW-13", name: "Leg Swings (Side-to-Side)", category: "SW", defaultReps: "10 each leg", notes: "Face wall, swing one leg side to side across body, keep torso stable", source: "Runner's World", videoUrl: "https://www.youtube.com/watch?v=korxBhGzzJE", isTimeBased: false, secondaryCategory: "LB" },
  { id: "SW-14", name: "Hip Circles", category: "SW", defaultReps: "10 each direction", notes: "Hands on hips, roll hips in large circles, then reverse direction", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=qkrJXGVj_OQ", isTimeBased: false, secondaryCategory: "LB" },
  { id: "SW-15", name: "Glute Bridges", category: "SW", defaultReps: "10", notes: "On back, knees bent, drive hips up squeezing glutes at top, lower with control", source: "BarBend", videoUrl: "https://barbend.com/best-dynamic-warm-up-exercises/", isTimeBased: false, secondaryCategory: "LB" },
  { id: "SW-16", name: "World's Greatest Stretch", category: "SW", defaultReps: "5 each side", notes: "Deep lunge, place hands inside front foot, rotate and reach to ceiling, return", source: "Muscle & Strength", videoUrl: "https://www.youtube.com/watch?v=kk8RnOLzngc", isTimeBased: false },
  { id: "SW-17", name: "High Knees", category: "SW", defaultReps: "20 each leg", notes: "Jog in place driving knees high, pump arms, stay on balls of feet", source: "BarBend", videoUrl: "https://barbend.com/best-dynamic-warm-up-exercises/", isTimeBased: false, secondaryCategory: "CP" },

  // ── Stretch – Cool-Down / Static (SC) ──
  { id: "SC-1", name: "Cobra Stretch", category: "SC", defaultReps: "20–30 sec", notes: "Lie face down, press up through hands arching spine, keep hips on ground", source: "The Rx Review", videoUrl: "https://www.youtube.com/watch?v=zWtLlhFp8HY", isTimeBased: true, secondaryCategory: "CF" },
  { id: "SC-2", name: "Child's Pose", category: "SC", defaultReps: "30 sec", notes: "From all fours, sit hips back toward heels, arms extended forward, forehead to floor", source: "NASM", videoUrl: "https://www.youtube.com/watch?v=_ZX_zTOBgp8", isTimeBased: true, secondaryCategory: "CS" },
  { id: "SC-3", name: "Seated Spinal Twist", category: "SC", defaultReps: "20 sec each side", notes: "Seated, cross one leg over the other, twist torso toward raised knee, hold", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=7CKr-RgOcIc", isTimeBased: true, secondaryCategory: "CR" },
  { id: "SC-4", name: "Lying Knee-to-Chest", category: "SC", defaultReps: "20 sec each side", notes: "On back, pull one knee to chest with both hands, keep other leg flat", source: "Ask Doctor Jo", videoUrl: "https://www.youtube.com/watch?v=Yd9wY25koVk", isTimeBased: true, secondaryCategory: "CL" },
  { id: "SC-5", name: "Chest Doorway Stretch", category: "SC", defaultReps: "20–30 sec", notes: "Forearms on doorframe at 90°, lean forward through doorway until chest stretch", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=O8rJw_TmC1Y", isTimeBased: true, secondaryCategory: "UP" },
  { id: "SC-6", name: "Overhead Triceps Stretch", category: "SC", defaultReps: "20 sec each arm", notes: "Raise arm overhead, bend elbow behind head, gently press elbow with other hand", source: "Dr. Fitology", videoUrl: "https://www.drfitology.com/exercises/triceps/overhead-triceps-stretch", isTimeBased: true, secondaryCategory: "UP" },
  { id: "SC-7", name: "Cross-Body Shoulder Stretch", category: "SC", defaultReps: "20 sec each arm", notes: "Pull one arm across chest with other hand, keep shoulder blades retracted and down", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=swvXpKN832E", isTimeBased: true, secondaryCategory: "UPL" },
  { id: "SC-8", name: "Standing Lat Stretch", category: "SC", defaultReps: "20 sec each side", notes: "Raise one arm overhead, grab wrist with other hand, lean to opposite side", source: "Dr. Fitology", videoUrl: "https://www.drfitology.com/exercises/lats/standing-lat-stretch", isTimeBased: true, secondaryCategory: "UPL" },
  { id: "SC-9", name: "Standing Quad Stretch", category: "SC", defaultReps: "20–30 sec each leg", notes: "Stand on one leg, grab opposite foot behind you, pull heel toward glute, keep knees together", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=Jb6JEEUGbDY", isTimeBased: true, secondaryCategory: "LB" },
  { id: "SC-10", name: "Standing Hamstring Stretch", category: "SC", defaultReps: "20–30 sec each leg", notes: "Place heel on elevated surface, hinge forward at hips with flat back until stretch felt", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=2s2t3mEYZNo", isTimeBased: true, secondaryCategory: "LB" },
  { id: "SC-11", name: "Pigeon Pose", category: "SC", defaultReps: "20–30 sec each side", notes: "From plank, bring one knee behind same-side wrist, lower hips, keep hips square", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=rKcfT_WZtsM", isTimeBased: true, secondaryCategory: "LB" },
  { id: "SC-12", name: "Standing Calf Stretch", category: "SC", defaultReps: "20–30 sec each leg", notes: "Face wall, stagger feet, lean forward keeping back heel down and back leg straight", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=LntxVU3jpgo", isTimeBased: true, secondaryCategory: "LB" },
  { id: "SC-13", name: "Butterfly Stretch", category: "SC", defaultReps: "20–30 sec", notes: "Seated, soles of feet together, gently press knees toward floor with elbows", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=NL3VK33_hYQ", isTimeBased: true, secondaryCategory: "LB" },
  { id: "SC-14", name: "Standing Forward Fold", category: "SC", defaultReps: "20–30 sec", notes: "Feet hip-width, hinge at hips with soft knees, let upper body hang, relax head and neck", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=phiM5CgL3m4", isTimeBased: true },
  { id: "SC-15", name: "Side Neck Stretch", category: "SC", defaultReps: "15–20 sec each side", notes: "Tilt ear toward shoulder, gently guide with hand, keep opposite shoulder anchored down", source: "YouTube", videoUrl: "https://www.youtube.com/watch?v=EWAsAseT39A", isTimeBased: true },
];
