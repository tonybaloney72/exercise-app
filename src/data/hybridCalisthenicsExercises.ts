...
export const hybridCalisthenicsExercises: Exercise[] = [
...

  {
    ...
    category: "CS",
    equipment: ["bodyweight", "plyo_box", "machine"],
    expertiseLevel: "intermediate",
    muscleGroups: ["Spinal Erectors"],
    defaultReps: "10",
    notes:
      "Torso on bench or machine pad; legs swing up. Bodyweight on bench or reverse hyper machine.",
    source: "RehabFix",
  ...
  },
  {
    ...
    notes:
      "Muscle focus: Serratus Anterior. Reference: Hybrid Calisthenics exercise library.",
    source: "Howcast",
    videoUrl: "https://www.youtube.com/watch?v=4ye2_HMmNbs",
    isTimeBased: false,
  },
