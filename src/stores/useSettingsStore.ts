...
function pickUserSettingsFields(
  ...
  return {
    ...
    completeExerciseOnSetTimerStop: state.completeExerciseOnSetTimerStop,
    timerVibrationEnabled: state.timerVibrationEnabled,
    keepScreenAwake: state.keepScreenAwake,
    writeWorkoutsToHealthConnect: state.writeWorkoutsToHealthConnect,
    ...
    repIncreaseBump: state.repIncreaseBump,
